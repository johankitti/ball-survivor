...
namespace Vuforia
{
	...
	/// </summary>
	public class WorldTrackableEventHandler : MonoBehaviour,
	ITrackableEventHandler
	{
		...
		private void SetButtonConnected(bool connected)
		{
			Text text = connectedButton.GetComponentInChildren<Text>();
			if (connected) {
